...
export function AppModalShell({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-surface-950/70 p-0 sm:items-center sm:p-4">
      <div
        className={`flex max-h-[calc(100svh-40px)] w-full ${maxWidthClass} flex-col overflow-hidden rounded-t-3xl border border-edge border-b-0 bg-surface-900 sm:max-h-[min(96svh,calc(100svh-40px))] sm:rounded-xl sm:border-b`}
        role="dialog"
        aria-modal="true"
