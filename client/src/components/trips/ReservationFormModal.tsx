  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="res-type" className="mb-1.5 block text-xs font-medium text-ink-muted">
            Tipo
          </label>
          <select
            id="res-type"
        ...
        <div>
          <label htmlFor="res-title" className="mb-1.5 block text-xs font-medium text-ink-muted">
            Nome
          </label>
          <input
            id="res-title"
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div>
            ...
            >
              Empresa <span className="text-ink-faint">(opcional)</span>
            </label>
            <input
              id="res-provider"
              value={provider}
          ...
          <div>
            <label htmlFor="res-code" className="mb-1.5 block text-xs font-medium text-ink-muted">
              Código <span className="text-ink-faint">(opcional)</span>
            </label>
            <input
              id="res-code"
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div>
            <label htmlFor="res-start" className="mb-1.5 block text-xs font-medium text-ink-muted">
              Início <span className="text-ink-faint">(opcional)</span>
            </label>
            <input
              id="res-start"
              type="datetime-local"
          ...
          <div>
            <label htmlFor="res-end" className="mb-1.5 block text-xs font-medium text-ink-muted">
              Fim <span className="text-ink-faint">(opcional)</span>
            </label>
            <input
              id="res-end"
              type="datetime-local"
        ...
        <div>
          <label htmlFor="res-address" className="mb-1.5 block text-xs font-medium text-ink-muted">
            Endereço <span className="text-ink-faint">(opcional)</span>
          </label>
          <input
            id="res-address"
            value={address}
        ...
        <div>
          <label htmlFor="res-url" className="mb-1.5 block text-xs font-medium text-ink-muted">
            Link <span className="text-ink-faint">(opcional)</span>
          </label>
          <input
            id="res-url"
            value={url}
        ...
        <div>
          <label htmlFor="res-notes" className="mb-1.5 block text-xs font-medium text-ink-muted">
